...
class MarsExplorerGUI:
    ...
    def animate_next_step(self):
        ...
        if current_pos in self.world_data[2] and current_pos not in self.collected_samples:
            self.collected_samples.add(current_pos)
    ...
    def update_cell_appearance(self, pos, original_val, is_astronaut=False):
        ...
        colors = {
            0: "#2d2d44", 1: "#1a1a1a", 2: "#4ecca3",
            3: "#8b4513", 4: "#ff6b35", 5: "#00d4ff", 6: "#e94560"
        }
    ...
    def draw_grid(self, parent):
        ...
        cell_size = min(max_cell_size, max(min_cell_size, min(cell_size_by_width, cell_size_by_height)))
